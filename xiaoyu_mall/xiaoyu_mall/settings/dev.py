...
SECRET_KEY = 'django-insecure-k3xwdi7g#91)w$-ax^4j4)-0^e^nx)*m0(*h1uh$##2bth%q$m'
...
CACHES = {
    ...
    'carts': {        # 购物车功能
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://127.0.0.1:6379/4', # 4号库
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
        }
    },
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(os.path.dirname(BASE_DIR), 'logs/xiaoyu.log'),
...
# 邮箱参数 # 授权码: HWIBOLAAIEHQIJQP
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'   # 指定邮件后端
EMAIL_HOST = 'smtp.163.com'                                     # 邮件主机
EMAIL_PORT = 25                                                 # 邮件端口
EMAIL_HOST_USER = 'hfn_nana@163.com'                            # 授权的邮箱
EMAIL_HOST_PASSWORD = 'HWIBOLAAIEHQIJQP'                        # 邮箱授权时获得的授权码
EMAIL_FROM = '小鱼商城<hfn_nana@163.com>'                      # 发件人抬头
